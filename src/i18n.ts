...
export const TASK_TITLES: Record<Locale, Record<LocalizedTaskKind, string[]>> = {
  en: {
    feature: [
      "Add bonus payments",
      "Add CSV export",
...
const UI: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "header.needValue": "Need +{value} value",
    "header.needTrust": "Need +{value} trust",
    "header.needValueAndTrust": "Need +{value} value and +{trust} trust",
    ...
    "morning.summary": "{shipped} shipped, {missed} missed. Today's backlog reflects the consequences.",
    ...
    "task.ships": "Ships 18:00",
    "task.released": "Зарелизено",
    "task.lateChip": "Просрочка -{value}%",
    "subtasks.title": "Checklist",
  ...
  ru: {
    ...
    "header.needValue": "Нужно еще +{value} value",
    "header.needTrust": "Нужно еще +{value} доверия",
    "header.needValueAndTrust": "Нужно еще +{value} value и +{trust} доверия",
    ...
    "morning.summary": "{shipped} уехало, {missed} пропущено. Сегодняшний бэклог учитывает последствия.",
    ...
    "task.ships": "Уедет в 18:00",
    "task.released": "Зарелизено",
    "task.lateChip": "Просрочка -{value}%",
    "subtasks.title": "Чеклист",
    "subtasks.unknown": "Неизвестная работа",
...
const RISK_REASON_LABELS: Record<Locale, Record<string, string>> = {
  ...
  ru: {
    ...
    deadline_pressure: "Давит дедлайн",
