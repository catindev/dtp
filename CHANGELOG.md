...
## 13. Code Freeze и анимация релиза
...
- `Ready for Done` остается только для полностью готовой карточки.
...
## 24. Текущее техническое состояние
...
7. Нужен ли туториал-подсказка первого дня или достаточно визуальных сигналов?
